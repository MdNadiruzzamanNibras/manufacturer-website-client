    ...
    return (
        <div className='my-24'>
            <div className='text-center'>
                <h2 className='text-4xl font-bold mb-4 text-blue-400 lg:ml-32'>Why Choose Us?</h2>
            ...
            <div className='grid lg:grid-cols-3 mt-14'>
                <div className='text-center'>
                   ...
                   <h4 className='text-2xl text-blue-400'> Quick Delivery
                ...
                <div className='text-center'>
                    ...
                    <h4 className='text-2xl text-blue-400'> Outstanding support</h4>
                ...
                <div className='text-center'>
                   ...
                   <h4 className='text-2xl text-blue-400'> Secure checkout
